      ...
      <div class="col-xl-6 col-lg-12">
          <div class="card card-info">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <div class="row">
                          <div class="form-group col-md-12">
                            ...
                            <a href="https://store.decoracionesgs.site/{{$depositos->ruta_imagen}}"><img src="https://store.decoracionesgs.site/{{$depositos->ruta_imagen}}" alt="Deposito" width="200"></a>
                          </div>
              ...
              <div class="card-footer">
                  ...
                  <a href="{!! route('pedido-cancelar', $pedidos->id_pedido)!!}"><button type="button" class="btn btn-danger active"><i class="fas fa-ban"></i> Cancelar Pedido</button></a>
              </div>
          </div>
          <!-- /.card -->
      </div>
