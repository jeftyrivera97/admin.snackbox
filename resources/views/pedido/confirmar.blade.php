...
<div class="container-fluid">
  <div class="row mb-2">
    <div class="col-sm-6">
      <h1 class="m-0 text-dark">Pedidos por Confirmar </h1>
    </div><!-- /.col -->
    <div class="col-sm-6">
  ...
  <div class="row">
    ...
    <tbody>   
      ...
      <tr>
        ...
        <td> <a href="{!! route('pedido-confirmar', $pedido->id_pedido)!!}"><button type="button" class="btn btn-success active btn-sm"><i class="fas fa-check-double"></i> Procesar</button></a></td>
    </tr>
  @endforeach
    </tbody>
</table>
